                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.reviews.update", [$review->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rate" id="rate" value="{{ old('rate', $review->rate) }}" required>
                            @if($errors->has('rate'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="body" id="body" value="{{ old('body', $review->body) }}">
                            @if($errors->has('body'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('body') }}
                                </div>
