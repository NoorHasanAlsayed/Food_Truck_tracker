...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#user_food_trucks" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="user_food_trucks">
            @includeIf('admin.users.relationships.userFoodTrucks', ['foodTrucks' => $user->userFoodTrucks])
        </div>
    </div>
</div>
