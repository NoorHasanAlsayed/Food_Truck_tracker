...
class CuisinesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.cuisines.index', compact('cuisines'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.cuisines.create');
    }
    ...
    public function store(StoreCuisineRequest $request)
    {
        ...
        return redirect()->route('frontend.cuisines.index');
    }
    ...
    public function edit(Cuisine $cuisine)
    {
        ...
        return view('frontend.cuisines.edit', compact('cuisine'));
    }
    ...
    public function show(Cuisine $cuisine)
    {
        ...
        return view('frontend.cuisines.show', compact('cuisine'));
    }
